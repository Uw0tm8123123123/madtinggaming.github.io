...
<body>
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" WIDTH="800" HEIGHT="600" id="run2.swf" ALIGN="">
<PARAM NAME=movie VALUE="run2.swf"> <PARAM NAME=quality VALUE=high> <PARAM NAME=bgcolor VALUE=#ffffff> <EMBED src="run2.swf" quality=high bgcolor=#ffffff WIDTH="800" HEIGHT="600" NAME="run2.swf" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED> </OBJECT>

<p><span style="text-decoration: underline; color: #800080; font-family: 'comic sans ms', sans-serif;"><span style="font-size: 20pt;"><strong>welcome to english revision (super sick)</strong></span></span></p>
